...
function Header() {
  return (
    <header>
      <div className="header_wrapper h-60 container_c w-65 mlr-auto">
        ...
        <div className="header_wrapper_search container-center">
          <div className="header_wrapper_search_input_suff">
            <svg
              aria-label="Search"
              class="_8-yf5 "
              color="#8e8e8e"
          ...
          <div className="header_wrapper_search_input_field">
            <input />
          </div>
        </div>
        <div className="header_wrapper_menu">
          <div className="header_wrapper_menu_item">
            <svg
              aria-label="Home"
              class="_8-yf5 "
              color="#262626"
          ...
          <div className="header_wrapper_menu_item">
            <div className="header_wrapper_menu_item_image ">
              <img
                alt="chokkerhritik's profile picture"
                class="_6q-tv"

...
function index() {
  return (
    <div className="head_base">
      <div className="head_base_content">
        <div className="head_base_content_logo">
          <img src={logo} alt=" " />
        </div>
        <div className="head_base_content_search">
          <input
            type={'search'}
            aria-label="Search Input"
            className="head_base_content_search_bar"
          />
          <div className="head_base_content_search_bar_icon">
            <svg
              aria-label="Search"
              class="_8-yf5 "
              color="#8e8e8e"
          ...
          <span className="head_base_content_search_bar_text">Search</span>
        </div>
        <div className="head_base_content_nav_Icons">
